...
export default function Step3Confirmation() {
  ...
  return (
    <div className="min-h-screen bg-black text-text">
      {/* ─── 1. Hero confirmation ─── */}
      <section className="pt-16 pb-8 px-6 text-center relative overflow-hidden">
        {/* Background glow */}
        ...
        <svg width="84" height="84" viewBox="0 0 84 84" className="mx-auto mb-8 relative drop-shadow-[0_0_20px_rgba(150,144,94,0.3)]">
          <circle
            ...
            style={{ animation: 'drawCircle 0.8s cubic-bezier(0.4, 0, 0.2, 1) forwards' }}
          />
          <path
            ...
            strokeDasharray="80"
            strokeDashoffset="80"
            style={{ animation: 'drawCheck 0.4s cubic-bezier(0.4, 0, 0.2, 1) 0.6s forwards' }}
          />
        </svg>

        <h1 className="font-display text-[clamp(40px,7vw,72px)] leading-[0.95] uppercase tracking-[2px] mb-3 relative">
          TA CANDIDATURE
          <br />
          EST ENVOYÉE.
        </h1>
      ...
      <section className="bg-deep py-16 px-6">
        <div className="max-w-[580px] mx-auto">
          <h2 className="font-display text-[clamp(28px,4.5vw,44px)] text-center uppercase tracking-[2px] mb-12">
            VOICI CE QUI SE PASSE MAINTENANT
          </h2>

          <div className="relative">
            {/* Timeline line with gradient */}
            <div className="absolute left-[17px] top-5 bottom-5 w-[2px] bg-gradient-to-b from-accent via-accent/50 to-border" />

            {confirmationSteps.map((step, i) => (
              <div key={i} className="flex items-start gap-5 mb-8 last:mb-0">
                <div
                  className={`w-9 h-9 rounded-full flex items-center justify-center text-[18px] shrink-0 z-10 shadow-[0_0_12px_rgba(150,144,94,0.2)] ${
                ...
                <div
                  className={`bg-card border border-border rounded-xl p-5 flex-1 shadow-premium hover:shadow-glow transition-all duration-300 ${
        ...
        <div className="max-w-[580px] mx-auto">
          ...
          <div className="space-y-4">
            {prepActions.map((bullet, i) => (
              <div key={i} className="bg-surface border border-border card-accent rounded-xl p-5 shadow-premium hover:shadow-glow transition-all duration-300 hover:-translate-y-0.5">
      ...
      <section className="bg-deep py-20 px-6">
        <div className="max-w-[560px] mx-auto text-center relative">
          <div className="font-serif text-[100px] leading-none text-accent/15 absolute top-0 left-1/2 -translate-x-1/2 -translate-y-4 pointer-events-none">&ldquo;</div>

          <blockquote className="font-serif italic text-[clamp(18px,2.5vw,24px)] text-text leading-relaxed mb-6 relative pt-8">
          ...
          <div className="separator-gold max-w-[80px] mx-auto mb-4" />
        ...
        <div className="max-w-[480px] mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            <a
              ...
              className="inline-flex items-center gap-2 bg-[#25D366] text-black font-bold py-3 px-6 rounded text-[14px] font-sans hover:-translate-y-0.5 transition-all duration-300 shadow-[0_4px_16px_rgba(37,211,102,0.3)] hover:shadow-[0_8px_24px_rgba(37,211,102,0.4)]"
            >
              Partager sur WhatsApp
            </a>
            <button
              onClick={handleCopy}
              className="inline-flex items-center gap-2 bg-surface border border-border text-accent font-semibold py-3 px-6 rounded text-[14px] font-sans hover:border-accent hover:shadow-[0_0_16px_rgba(150,144,94,0.1)] transition-all duration-300 cursor-pointer"
            >
